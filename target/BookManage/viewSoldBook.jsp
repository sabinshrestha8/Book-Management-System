...
<div class="container w-50 my-4">
    <div class="btn-wrap d-flex flex-row-reverse">
        <a href="#" class="btn btn-primary btn-sm">Sale a Book</a>
        <a href="#" class="btn btn-secondary btn-sm mx-2">View Sold Books</a>
    </div>
    <table class="table">
        <thead>
        <tr>
        ...
        <tbody>
        <%
            System.out.println(request.getAttribute("soldBooks"));
        %>
